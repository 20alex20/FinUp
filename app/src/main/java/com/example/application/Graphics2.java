    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PyObject obj = pyobj.callAttr("graph", false, "plot", Et1.getText().toString(), Et2.getText().toString());
        ...
        Btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PyObject obj = pyobj.callAttr("graph", false, "bar", Et1.getText().toString(), Et2.getText().toString());
                byte[] ba = obj.toJava(byte[].class);
                iv.setVisibility(View.VISIBLE);
                iv.setImageBitmap(BitmapFactory.decodeByteArray(ba,0, ba.length));
            }
        ...
        Btn4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PyObject obj = pyobj.callAttr("graph", false, "bar2", Et1.getText().toString(), Et2.getText().toString());
                //String s = obj.toString();
                //Toast.makeText(getApplicationContext(),s,Toast.LENGTH_LONG).show();
                byte[] ba = obj.toJava(byte[].class);
                iv.setVisibility(View.VISIBLE);
